...
DOCUMENTATION = r'''
---
module: private.de_info
short_description: Gather information about CDP DE Workspaces in Private Cloud
description:
    - Gather information about CDP DE Workspaces in Private Cloud
author:
...
# List basic information about all DE Services in Privare Cloud
- cloudera.cloud.private.de_info:
...
RETURN = r'''
services:
  description: List of DE service descriptions in Private Cloud
  type: list
  returned: always
  elements: complex
  contains:
